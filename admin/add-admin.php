...
if(isset($_POST['update_admin']))
{
	...
	$passwd=$_POST['passwd'];
	$image=$_POST['image'];
	$q="INSERT INTO `admin`(`user_name`, `password`, `name`, `photo`, `designation`) VALUES ('$user','$passwd','$name','$image','$desi')";
	...
	if($res)
	{
		...
		echo "<script type='text/javascript'>alert('Error: Failled to upload details')</script>";
		}
