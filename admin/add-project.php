...
if(isset($_POST['submit']))
{
  ...
  $author=$_POST['author'];
  $appby=$_POST['appby'];
  $q="INSERT INTO `projects`(`project_id`, `project_name`, `publisher_name`, `date`, `author`, `approved_by`) VALUES ('$id','$name','$pubname','$date','$author','$appby')";
