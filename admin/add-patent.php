...
if(isset($_POST['add_patent']))
{
  ...
  $cbr=$_POST['cbr'];
  $date=$_POST['date'];
  $q="INSERT INTO `patents`(`patent_status`, `applicant_id`, `application_no`, `reciept_of_cbr`, `date`) VALUES ('$type','$id','$number','$cbr','$date')";
  ...
  if($r){
	...
	echo "<script type='text/javascript'>alert('Error: Failled to insert')</script>";
	}
					...
					<div class="row">
						...
						<div class="col-lg-9 col-md-9 col-sm-12">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 pb-4">
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item active" aria-current="page">Dashboard/Add Patent</li>
										</ol>
									</nav>
								</div>
							</div>
							...
							<!-- <div class="xl-12 col-lg-12 col-md-12" >
									...
									<div class="alert alert-danger text-center mb-0" id="test" >
											Patent Succesfully Added
									</div>
						</div> -->
							<div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
								<form action="" method="POST">
										<h3 class="ml-0">ADD PATENT</h3>
									</div>
									
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>Patent ID<i class="req">*</i></label>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>Patent Application Number<i class="req">*</i></label>
											<input type="text" name="number"  class="form-control">
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>Recipt of CBR<i class="req">*</i></label>
											<input type="text" name="cbr" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
									<button type="submit" name="add_patent" class="btn btn-primary">Submit</button>
                                    </div>
									</form>
							<!-- form end Row -->
