...
if(isset($_POST['submit']))
{
  ...
  $author=$_POST['author'];
  $appby=$_POST['appby'];
  $q="UPDATE `projects` SET `project_name`='$name',`publisher_name`='$pubname',`date`='$date',`author`='$author',`approved_by`='$appby' WHERE `project_id`='$id'";
  ...
  if($r){
	...
	echo "<script type='text/javascript'>alert('Error: Failled to update data')</script>";
	}
					...
					<div class="row">
                        ...
                        <form method="POST">
                            <div class="col-lg-12 col-md-12 col-sm-12">
										<h3 class="ml-0">EDIT PROJECT</h3>
									</div>
									
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>Project ID<i class="req">*</i></label>
									...
									<div class="col-lg-12 col-md-12 col-sm-12">
										<div class="form-group">
											<label>Publisher Name<i class="req">*</i></label>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>Author's<i class="req">*</i></label>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>Approval By<i class="req">*</i></label>
											<input type="text" name="appby"class="form-control">
										</div>
									</div>
