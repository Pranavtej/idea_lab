...
if(isset($_POST['submit']))
{
	...
	$type=$_POST['type'];
	$given=$_POST['given'];
	$q="UPDATE `awards` SET `title`='$title',`organisation`='$org',`type`='$type',`given`='$given' WHERE `id`='$id'";
...
?>
							...
							<!-- form startRow -->
                                   ...
                                   <div class="col-lg-12 col-md-12 col-sm-12">
										<h3 class="ml-0">ADD AWARD</h3>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>Award Id<i class="req">*</i></label>
											<input type="text" name="id" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>Award Title<i class="req">*</i></label>
											<input type="text" name="title" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>Organization<i class="req">*</i></label>
											<input type="text" name="org" class="form-control">
										</div>
									</div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>Type of Award<i class="req">*</i></label>
											<input type="text" name="type" class="form-control">
										</div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>Given Type<i class="req">*</i></label>
											<select id="event" name="given"class="form-control">
