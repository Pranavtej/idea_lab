...
if(isset($_POST['update_admin']))
{
	...
	$passwd=$_POST['passwd'];
	$image=$_POST['image'];
	$q="UPDATE `admin` SET `password`='$passwd',`name`='$name',`photo`='$image',`designation`='$desi' WHERE `user_name`='$user'";
	...
	if($res)
	{
		...
		echo "<script type='text/javascript'>alert('Error: Failled to update details')</script>";
		}
...
?>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
										<h3 class="ml-0">MANAGE ADMINS</h3>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>Name<i class="req">*</i></label>
											<input type="text" name="name" place holder="Enter Fullname" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>Designation<i class="req">*</i></label>
											<input type="text" name="desig" place holder="Enter Designation" class="form-control">
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>User Name<i class="req" >*</i></label>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											...
											<input type="password" name="passwd" place holder="Set Password"class="form-control">
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>Confirm Password<i class="req">*</i></label>
											<input type="password" name="cpasswd" place holder="Confirm Password"class="form-control">
										</div>
									</div>
									<div>
									...
									<button type="submit" name="update_admin" class="btn btn-primary">update user</button>
							<!-- form end Row -->
								</div>
								<!--/row -->
