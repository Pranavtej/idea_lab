...
if(isset($_POST['submit']))
{
	...
	$date=$_POST['date'];
	$image=$_POST['image'];
	$q="INSERT INTO `events`(`id`,`event`, `title`, `photo`, `description`, `date`) VALUES ('$id','$type','$event','$image','$desc','$date')";
...
?>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
										<h3 class="ml-0">EDIT EVENTS</h3>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>Event Id<i class="req">*</i></label>
											<input type="text" name="id"class="form-control">
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>Event name<i class="req">*</i></label>
									...
									<div class="col-lg-12 col-md-12 col-sm-12">
										<div class="form-group">
											<label>Event Type<i class="req">*</i></label>
											<select id="event" name="type" class="form-control">
												<option value="" selected>select event</option>
												<option value="Facualty Developement Program">Facualty Developement Program</option>
												<option value="Professional Skilling Program">Professional Skilling Program</option>
												<option value="Skilling Program">Skilling Program</option>
												<option value="School Teacher Awareness Programmes">School Teacher Awareness Programmes</option>
												<option value="Open Day for School Student">Open Day for School Student</option>
												<option value="Annual Conference">Annual Conference</option>
												<option value="Bootcamp">Bootcamp</option>
												<option value="Ideation Workshops">Ideation Workshops</option>
												<option value="Internships">Internships</option>
												<option value="Awareness Workshop to Industry">Awareness Workshop to Industry</option>
												<option value="Project By School Students">Project By School Students</option>
											</select>
										</div>
									</div>
