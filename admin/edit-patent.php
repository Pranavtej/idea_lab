...
if(isset($_POST['submit']))
{
  ...
  $cbr=$_POST['cbr'];
  $date=$_POST['date'];
  $q="UPDATE `patents` SET `patent_status`='$status',`application_no`='$number',`reciept_of_cbr`='$cbr',`date`='$date' WHERE `applicant_id`='$id'";
						...
						<div class="col-lg-9 col-md-9 col-sm-12">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
								<form action="" method="POST">
									...
									<div class="col-lg-12 col-md-12 col-sm-12">
										<div class="form-group">
											<label>Patent Status<i class="req">*</i></label>
